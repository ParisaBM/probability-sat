...
class SatInstance:
    ...
    # the identifiers are from 1 to num_variables inclusively, 0 is not used as an identifier
        ...
        with open(filename) as file:
            ...
            for line in file:
                ...
                if not reached_problem_line:
                    ...
                    # a 0 delimits the start of a new clause
                    for literal in tokens:
                        try:
                            ...
                            if literal_as_int == 0:
                                ...
                                self.clauses[-1].append((literal_as_int > 0, abs(literal_as_int)))                     
                        except:
